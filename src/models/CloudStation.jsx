...
import cloudStationScene from './cloudstation.glb';
import {a} from '@react-spring/three';

const CloudStation = ({isRotating, setIsRotating, ...props}) => {
  const group = useRef();
  ...
  const { nodes, materials, animations } = useGLTF(cloudStationScene);
  ...
  const handlePointerMove = (e) => {
    ...
    if(isRotating){
      ...
      group.current.rotation.y += delta * 0.1 * Math.PI;
      lastX.current = clientX;
